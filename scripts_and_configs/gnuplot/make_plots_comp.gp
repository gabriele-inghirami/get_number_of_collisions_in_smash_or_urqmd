...
dirs="ratio_urqmd_smash_timeless ratio_smash_std_smash_timeless"
titles="'UrQMD / SMASH TIMELESS' 'SMASH STD / SMASH TIMELESS'"
...
set out outdir."Ecm_17_3.eps"
set title "Pb+Pb, b = 0-3.3 fm, {/Symbol \326}s = 17.3 GeV".word(titles,k)
pf=word(dirs,k)."/17_3/".cft
plot pf u 1:2 w l ls 1 t "elastic", pf u 1:3 w l ls 2 t "decays", pf u 1:4 w l ls 3 t "strings", pf u 1:5 w l ls 4 t "other"

set out outdir."Ecm_200.eps"
set title "Pb+Pb, b = 0-3.3 fm, {/Symbol \326}s = 200200.3 GeV".word(titles,k)
pf=word(dirs,k)."/200/".cft
plot pf u 1:2 w l ls 1 t "elastic", pf u 1:3 w l ls 2 t "decays", pf u 1:4 w l ls 3 t "strings", pf u 1:5 w l ls 4 t "other"
}
...
do for [en=1:words(energies)] {
   ...
   do for [kn=1:words(names)] {
      set out outdir."Ecm_".word(energies,en)."_".word(names,kn).".eps"
      ...
      plot u_ss u 1:indx w l lw 4 lc "red" dt 1 t word(titles,1), u_sm u 1:indx w l lw 4 lc "blue" dt 2 t word(titles,2)
   }
}
