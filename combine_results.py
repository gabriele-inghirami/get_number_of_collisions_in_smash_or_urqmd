...
label_header,file_kind,events,dt,times,elastic,decays,strings,other,detailed,two_stable,one_stable,no_stable,\
        min_one_anti,BaBa,MeBa,MeMe,NuNu,Nupi,pipi,NuNustar,created_hadrons,cross_sections = data[:]
data=None
...
for fi in range(3,N_args):
    ...
    NuNu_new,Nupi_new,pipi_new,NuNustar_new,created_hadrons_new,cross_sections_new = data[:]
    data = None
    ...
    created_hadrons += created_hadrons_new
